...
Informed consent for participation in the experiment and publication of data was obtained from all individual
...
Note: Response time and No. comparisons are auxiliary results, and therefore not our main analysis focus. We do,
...
Graphs from human sort trace analysis with chi-sq alpha set to 0.025 can be generated by setting the following flags in
the 'extract_from_CSV' function,
