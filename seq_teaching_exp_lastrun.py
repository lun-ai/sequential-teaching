...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\allen\\OneDrive\\Documents\\GitHub\\seq_teaching_interface\\seq_teaching_exp_lastrun.py',
...
consent = visual.TextStim(win=win, name='consent',
    ...
    languageStyle='LTR',
    depth=0.0);
consent_check = visual.Slider(win=win, name='consent_check',
    startValue=None, size=(0.5, 0.02), pos=(0, -0.35), units=None,
    labels=["I agree","Exit"], ticks=[1,2], granularity=1.0,
...
PRE_TEST_INTROClock = core.Clock()
pre_test_intro = visual.TextStim(win=win, name='pre_test_intro',
    ...
    languageStyle='LTR',
    depth=0.0);
pre_test_intro_btn = visual.ImageStim(
    win=win,
    name='pre_test_intro_btn', 
    image='materials/imgs/continue.png', mask=None,
    ori=0.0, pos=(0, -0.4), size=[0.28,0.1],
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-1.0)
pre_test_intro_mouse = event.Mouse(win=win)
x, y = [None, None]
pre_test_intro_mouse.mouseClock = core.Clock()

# Initialize components for Routine "PRE_TEST_TRAIN"
PRE_TEST_TRAINClock = core.Clock()
pre_test_train_item = visual.ImageStim(
    win=win,
    name='pre_test_train_item', 
    image='sin', mask=None,
    ori=0.0, pos=(0, 0.06), size=(0.66, 0.72),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
pre_test_train_whitescreen = visual.ImageStim(
    win=win,
    name='pre_test_train_whitescreen', 
    image='sin', mask=None,
    ori=0.0, pos=(0, 0.06), size=(0.66, 0.72),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-1.0)
pre_test_train_fixation = visual.ImageStim(
    win=win,
    name='pre_test_train_fixation', 
    image='sin', mask=None,
    ori=0.0, pos=(0, 0.06), size=(0.66, 0.72),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
pre_test_train_slider = visual.Slider(win=win, name='pre_test_train_slider',
    startValue=None, size=(0.48, 0.04), pos=(0, -0.4), units=None,
...
pre_test_train_mouse = event.Mouse(win=win)
x, y = [None, None]
pre_test_train_mouse.mouseClock = core.Clock()
pre_test_train_timer = visual.TextStim(win=win, name='pre_test_train_timer',
    text=None,
    font='Open Sans',
    pos=(0.6, -0.3), height=0.03, wrapWidth=None, ori=0.0, 
    color='orange', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-5.0);
pre_test_train_counter_1 = visual.TextStim(win=win, name='pre_test_train_counter_1',
    text=None,
    font='Open Sans',
    pos=(0.6, 0.1), height=0.03, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-6.0);
pre_test_train_counter_2 = visual.TextStim(win=win, name='pre_test_train_counter_2',
    text=None,
    font='Open Sans',
    ...
    languageStyle='LTR',
    depth=-7.0);
pre_test_train_instr = visual.TextStim(win=win, name='pre_test_train_instr',
    ...
    languageStyle='LTR',
    depth=-8.0);
pre_test_train_feedback = visual.TextStim(win=win, name='pre_test_train_feedback',
    text=None,
    font='Open Sans',
    ...
    languageStyle='LTR',
    depth=-9.0);
pre_test_train_mark = visual.TextStim(win=win, name='pre_test_train_mark',
    text='',
    font='Open Sans',
...
PRE_TESTClock = core.Clock()
pre_test_item = visual.ImageStim(
    win=win,
    name='pre_test_item', 
    image='sin', mask=None,
    ori=0.0, pos=(0, 0.06), size=(0.66, 0.72),
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
pre_test_whitescreen = visual.ImageStim(
    win=win,
    name='pre_test_whitescreen', 
    image='sin', mask=None,
    ori=0.0, pos=(0, 0.06), size=(0.66, 0.72),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-1.0)
pre_test_fixation = visual.ImageStim(
    win=win,
    name='pre_test_fixation', 
    image='sin', mask=None,
    ori=0.0, pos=(0, 0.06), size=(0.66, 0.72),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
pre_test_slider = visual.Slider(win=win, name='pre_test_slider',
    startValue=None, size=(0.48, 0.04), pos=(0, -0.4), units=None,
    labels=None, ticks=(1, 2, 3, 4), granularity=1.0,
    style='radio', styleTweaks=(), opacity=None,
    color='white', fillColor='black', borderColor='white', colorSpace='rgb',
    font='Open Sans', labelHeight=0.05,
    flip=False, depth=-3, readOnly=False)
pre_test_mouse = event.Mouse(win=win)
x, y = [None, None]
pre_test_mouse.mouseClock = core.Clock()
pre_test_timer = visual.TextStim(win=win, name='pre_test_timer',
    text=None,
    font='Open Sans',
    pos=(0.6, -0.3), height=0.03, wrapWidth=None, ori=0.0, 
    color='orange', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-5.0);
pre_test_instr = visual.TextStim(win=win, name='pre_test_instr',
    text='The 3x3 tiles relate to each other in one or more of these aspects: \n\ncolour, size, position and shape. \n\nCHOOSE one of the 4 provided options (A/B/C/D) that will correctly complete the tiles by REPLACING the "?".\n\nYou have 30 SECS for each question!',
    font='Open Sans',
    pos=(-0.6, 0), height=0.03, wrapWidth=0.4, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-6.0);
pre_test_counter = visual.TextStim(win=win, name='pre_test_counter',
    text='Test question',
    font='Open Sans',
    pos=(0.6, 0), height=0.03, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-7.0);
pre_test_mark = visual.TextStim(win=win, name='pre_test_mark',
    text='',
    font='Open Sans',
    pos=(0.15, 0.02), height=0.1, wrapWidth=0.4, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
...
break_1_instr = visual.TextStim(win=win, name='break_1_instr',
    ...
    languageStyle='LTR',
    depth=0.0);
break_1_mouse = event.Mouse(win=win)
x, y = [None, None]
break_1_mouse.mouseClock = core.Clock()
break_1_btn = visual.ImageStim(
    win=win,
    name='break_1_btn', 
    image='materials/imgs/continue.png', mask=None,
    ori=0.0, pos=(0, -0.4), size=[0.28,0.1],
...
bob = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
blue_star_door = visual.ImageStim(
    win=win,
    name='blue_star_door', 
    image='materials/merge_sort/imgs/blue_star_door.png', mask=None,
    ori=0.0, pos=(-0.4, 0.2), size=(0.15, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-3.0)
purple_diamond_door = visual.ImageStim(
    win=win,
    name='purple_diamond_door', 
    image='materials/merge_sort/imgs/purple_diamond_door.png', mask=None,
    ori=0.0, pos=(0.4, 0.2), size=(0.15, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
bob_5 = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-3.0)
blue_star_door_2 = visual.ImageStim(
    win=win,
    name='blue_star_door_2', 
    image='materials/merge_sort/imgs/blue_star_door.png', mask=None,
    ori=0.0, pos=(-0.5, 0.2), size=(0.15, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-4.0)
purple_diamond_door_2 = visual.ImageStim(
    win=win,
    name='purple_diamond_door_2', 
    image='materials/merge_sort/imgs/purple_diamond_door.png', mask=None,
    ori=0.0, pos=(0.5, 0.2), size=(0.15, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
merge_example = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
blue_star_door_3 = visual.ImageStim(
    win=win,
    name='blue_star_door_3', 
    image='materials/merge_sort/imgs/blue_star_door.png', mask=None,
...
merge_example_2 = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
blue_star_door_4 = visual.ImageStim(
    win=win,
    name='blue_star_door_4', 
    image='materials/merge_sort/imgs/blue_star_door.png', mask=None,
    ori=0.0, pos=(-0.45, 0.25), size=(0.15, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
sort_example = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
purple_diamond_door_3 = visual.ImageStim(
    win=win,
    name='purple_diamond_door_3', 
    image='materials/merge_sort/imgs/purple_diamond_door.png', mask=None,
    ori=0.0, pos=(0.45, 0.25), size=(0.15, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
break_2_instr = visual.TextStim(win=win, name='break_2_instr',
    text='You may take a short break now!\n\nPlease do not refresh/close the browser tab or leave your device to sleep.\n\nClick the "Continue" button below when you are ready to proceed!',
    font='Open Sans',
    pos=(0, 0.0), height=0.03, wrapWidth=None, ori=0.0, 
    color='yellow', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=0.0);
break_2_mouse = event.Mouse(win=win)
x, y = [None, None]
break_2_mouse.mouseClock = core.Clock()
break_2_btn = visual.ImageStim(
    win=win,
    name='break_2_btn', 
    image='materials/imgs/continue.png', mask=None,
    ori=0.0, pos=(0, -0.4), size=[0.28,0.1],
...
sort_example_2 = visual.ImageStim(
    ...
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
purple_diamond_door_4 = visual.ImageStim(
    win=win,
    name='purple_diamond_door_4', 
    image='materials/merge_sort/imgs/purple_diamond_door.png', mask=None,
    ori=0.0, pos=(0.45, 0.25), size=(0.15, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
exp_check_slider = visual.Slider(win=win, name='exp_check_slider',
    startValue=None, size=(0.5, 0.02), pos=(0, 0.1), units=None,
    labels=("HAD training", "NO training"), ticks=(1, 2), granularity=1.0,
    style='radio', styleTweaks=(), opacity=None,
    color='white', fillColor='black', borderColor='White', colorSpace='rgb',
    font='Open Sans', labelHeight=0.03,
...
CONSENTComponents = [consent, consent_check]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if consent.status == STARTED:
        ...
        if tThisFlipGlobal > consent.tStartRefresh + 180.0-frameTolerance:
            # keep track of stop time/frame for later
            consent.tStop = t  # not accounting for scr refresh
            consent.frameNStop = frameN  # exact frame index
            win.timeOnFlip(consent, 'tStopRefresh')  # time at next scr refresh
            consent.setAutoDraw(False)
    
    # *consent_check* updates
    if consent_check.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        consent_check.frameNStart = frameN  # exact frame index
        consent_check.tStart = t  # local t and not account for scr refresh
        consent_check.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(consent_check, 'tStartRefresh')  # time at next scr refresh
        consent_check.setAutoDraw(True)
    if consent_check.status == STARTED:
        # is it time to stop? (based on local clock)
        if tThisFlip > 180.0-frameTolerance:
            # keep track of stop time/frame for later
            consent_check.tStop = t  # not accounting for scr refresh
            consent_check.frameNStop = frameN  # exact frame index
            win.timeOnFlip(consent_check, 'tStopRefresh')  # time at next scr refresh
...
thisExp.addData('consent_check.response', consent_check.getRating())
...
# keep track of which components have finished
PRE_TEST_INTROComponents = [pre_test_intro, pre_test_intro_btn, pre_test_intro_mouse]
for thisComponent in PRE_TEST_INTROComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
PRE_TEST_INTROClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "PRE_TEST_INTRO"-------
while continueRoutine and routineTimer.getTime() > 0:
    # get current time
    t = PRE_TEST_INTROClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=PRE_TEST_INTROClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *pre_test_intro* updates
    if pre_test_intro.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        pre_test_intro.frameNStart = frameN  # exact frame index
        pre_test_intro.tStart = t  # local t and not account for scr refresh
        pre_test_intro.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(pre_test_intro, 'tStartRefresh')  # time at next scr refresh
        pre_test_intro.setAutoDraw(True)
    if pre_test_intro.status == STARTED:
        # is it time to stop? (based on local clock)
        if tThisFlip > 120.0-frameTolerance:
            # keep track of stop time/frame for later
            pre_test_intro.tStop = t  # not accounting for scr refresh
            pre_test_intro.frameNStop = frameN  # exact frame index
            win.timeOnFlip(pre_test_intro, 'tStopRefresh')  # time at next scr refresh
            pre_test_intro.setAutoDraw(False)
    
    # *pre_test_intro_btn* updates
    if pre_test_intro_btn.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
        # keep track of start time/frame for later
        pre_test_intro_btn.frameNStart = frameN  # exact frame index
        pre_test_intro_btn.tStart = t  # local t and not account for scr refresh
        pre_test_intro_btn.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(pre_test_intro_btn, 'tStartRefresh')  # time at next scr refresh
        pre_test_intro_btn.setAutoDraw(True)
    if pre_test_intro_btn.status == STARTED:
        # is it time to stop? (based on local clock)
        if tThisFlip > 120.0-frameTolerance:
            # keep track of stop time/frame for later
            pre_test_intro_btn.tStop = t  # not accounting for scr refresh
            pre_test_intro_btn.frameNStop = frameN  # exact frame index
            win.timeOnFlip(pre_test_intro_btn, 'tStopRefresh')  # time at next scr refresh
...
x, y = pre_test_intro_mouse.getPos()
buttons = pre_test_intro_mouse.getPressed()
thisExp.addData('pre_test_intro_mouse.x', x)
thisExp.addData('pre_test_intro_mouse.y', y)
thisExp.addData('pre_test_intro_mouse.leftButton', buttons[0])
thisExp.addData('pre_test_intro_mouse.midButton', buttons[1])
thisExp.addData('pre_test_intro_mouse.rightButton', buttons[2])
thisExp.nextEntry()
pass

# set up handler to look after randomisation of conditions etc
MaRs_IB_1 = data.TrialHandler(nReps=1.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('materials/pre_test_train_cond.csv'),
    seed=None, name='MaRs_IB_1')
thisExp.addLoop(MaRs_IB_1)  # add the loop to the experiment
thisMaRs_IB_1 = MaRs_IB_1.trialList[0]  # so we can initialise stimuli with some values
# abbreviate parameter names if possible (e.g. rgb = thisMaRs_IB_1.rgb)
if thisMaRs_IB_1 != None:
    for paramName in thisMaRs_IB_1:
        exec('{} = thisMaRs_IB_1[paramName]'.format(paramName))

for thisMaRs_IB_1 in MaRs_IB_1:
    currentLoop = MaRs_IB_1
    # abbreviate parameter names if possible (e.g. rgb = thisMaRs_IB_1.rgb)
    if thisMaRs_IB_1 != None:
        for paramName in thisMaRs_IB_1:
            exec('{} = thisMaRs_IB_1[paramName]'.format(paramName))
    ...
    # keep track of which components have finished
    PRE_TEST_TRAINComponents = [pre_test_train_item, pre_test_train_whitescreen, pre_test_train_fixation, pre_test_train_slider, pre_test_train_mouse, pre_test_train_timer, pre_test_train_counter_1, pre_test_train_counter_2, pre_test_train_instr, pre_test_train_feedback, pre_test_train_mark]
    for thisComponent in PRE_TEST_TRAINComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    PRE_TEST_TRAINClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "PRE_TEST_TRAIN"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = PRE_TEST_TRAINClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=PRE_TEST_TRAINClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *pre_test_train_item* updates
        if pre_test_train_item.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_item.frameNStart = frameN  # exact frame index
            pre_test_train_item.tStart = t  # local t and not account for scr refresh
            pre_test_train_item.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_item, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_item.setAutoDraw(True)
        if pre_test_train_item.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_item.tStop = t  # not accounting for scr refresh
                pre_test_train_item.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_item, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_item.setAutoDraw(False)
        
        # *pre_test_train_whitescreen* updates
        if pre_test_train_whitescreen.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_whitescreen.frameNStart = frameN  # exact frame index
            pre_test_train_whitescreen.tStart = t  # local t and not account for scr refresh
            pre_test_train_whitescreen.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_whitescreen, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_whitescreen.setAutoDraw(True)
        if pre_test_train_whitescreen.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 0.6-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_whitescreen.tStop = t  # not accounting for scr refresh
                pre_test_train_whitescreen.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_whitescreen, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_whitescreen.setAutoDraw(False)
        
        # *pre_test_train_fixation* updates
        if pre_test_train_fixation.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_fixation.frameNStart = frameN  # exact frame index
            pre_test_train_fixation.tStart = t  # local t and not account for scr refresh
            pre_test_train_fixation.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_fixation, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_fixation.setAutoDraw(True)
        if pre_test_train_fixation.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 0.5-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_fixation.tStop = t  # not accounting for scr refresh
                pre_test_train_fixation.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_fixation, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_fixation.setAutoDraw(False)
        
        # *pre_test_train_slider* updates
        if pre_test_train_slider.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_slider.frameNStart = frameN  # exact frame index
            pre_test_train_slider.tStart = t  # local t and not account for scr refresh
            pre_test_train_slider.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_slider, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_slider.setAutoDraw(True)
        if pre_test_train_slider.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_slider.tStop = t  # not accounting for scr refresh
                pre_test_train_slider.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_slider, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_slider.setAutoDraw(False)
        
        # *pre_test_train_timer* updates
        if pre_test_train_timer.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_timer.frameNStart = frameN  # exact frame index
            pre_test_train_timer.tStart = t  # local t and not account for scr refresh
            pre_test_train_timer.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_timer, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_timer.setAutoDraw(True)
        if pre_test_train_timer.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_timer.tStop = t  # not accounting for scr refresh
                pre_test_train_timer.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_timer, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_timer.setAutoDraw(False)
        
        # *pre_test_train_counter_1* updates
        if pre_test_train_counter_1.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_counter_1.frameNStart = frameN  # exact frame index
            pre_test_train_counter_1.tStart = t  # local t and not account for scr refresh
            pre_test_train_counter_1.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_counter_1, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_counter_1.setAutoDraw(True)
        if pre_test_train_counter_1.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_counter_1.tStop = t  # not accounting for scr refresh
                pre_test_train_counter_1.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_counter_1, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_counter_1.setAutoDraw(False)
        
        # *pre_test_train_counter_2* updates
        if pre_test_train_counter_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_counter_2.frameNStart = frameN  # exact frame index
            pre_test_train_counter_2.tStart = t  # local t and not account for scr refresh
            pre_test_train_counter_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_counter_2, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_counter_2.setAutoDraw(True)
        if pre_test_train_counter_2.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_counter_2.tStop = t  # not accounting for scr refresh
                pre_test_train_counter_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_counter_2, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_counter_2.setAutoDraw(False)
        
        # *pre_test_train_instr* updates
        if pre_test_train_instr.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_instr.frameNStart = frameN  # exact frame index
            pre_test_train_instr.tStart = t  # local t and not account for scr refresh
            pre_test_train_instr.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_instr, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_instr.setAutoDraw(True)
        if pre_test_train_instr.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_instr.tStop = t  # not accounting for scr refresh
                pre_test_train_instr.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_instr, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_instr.setAutoDraw(False)
        
        # *pre_test_train_feedback* updates
        if pre_test_train_feedback.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_feedback.frameNStart = frameN  # exact frame index
            pre_test_train_feedback.tStart = t  # local t and not account for scr refresh
            pre_test_train_feedback.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_feedback, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_feedback.setAutoDraw(True)
        if pre_test_train_feedback.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_feedback.tStop = t  # not accounting for scr refresh
                pre_test_train_feedback.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_feedback, 'tStopRefresh')  # time at next scr refresh
                pre_test_train_feedback.setAutoDraw(False)
        
        # *pre_test_train_mark* updates
        if pre_test_train_mark.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
            # keep track of start time/frame for later
            pre_test_train_mark.frameNStart = frameN  # exact frame index
            pre_test_train_mark.tStart = t  # local t and not account for scr refresh
            pre_test_train_mark.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_train_mark, 'tStartRefresh')  # time at next scr refresh
            pre_test_train_mark.setAutoDraw(True)
        if pre_test_train_mark.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 31.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_train_mark.tStop = t  # not accounting for scr refresh
                pre_test_train_mark.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_train_mark, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in PRE_TEST_TRAINComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    MaRs_IB_1.addData('pre_test_train_slider.response', pre_test_train_slider.getRating())
    # store data for MaRs_IB_1 (TrialHandler)
    x, y = pre_test_train_mouse.getPos()
    buttons = pre_test_train_mouse.getPressed()
    MaRs_IB_1.addData('pre_test_train_mouse.x', x)
    MaRs_IB_1.addData('pre_test_train_mouse.y', y)
    MaRs_IB_1.addData('pre_test_train_mouse.leftButton', buttons[0])
    MaRs_IB_1.addData('pre_test_train_mouse.midButton', buttons[1])
    MaRs_IB_1.addData('pre_test_train_mouse.rightButton', buttons[2])
    thisExp.nextEntry()
    
# completed 1.0 repeats of 'MaRs_IB_1'


# set up handler to look after randomisation of conditions etc
MaRs_IB_2 = data.TrialHandler(nReps=10.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('materials/pre_test_cond.csv'),
    seed=None, name='MaRs_IB_2')
thisExp.addLoop(MaRs_IB_2)  # add the loop to the experiment
thisMaRs_IB_2 = MaRs_IB_2.trialList[0]  # so we can initialise stimuli with some values
# abbreviate parameter names if possible (e.g. rgb = thisMaRs_IB_2.rgb)
if thisMaRs_IB_2 != None:
    for paramName in thisMaRs_IB_2:
        exec('{} = thisMaRs_IB_2[paramName]'.format(paramName))

for thisMaRs_IB_2 in MaRs_IB_2:
    currentLoop = MaRs_IB_2
    # abbreviate parameter names if possible (e.g. rgb = thisMaRs_IB_2.rgb)
    if thisMaRs_IB_2 != None:
        for paramName in thisMaRs_IB_2:
            exec('{} = thisMaRs_IB_2[paramName]'.format(paramName))
    ...
    # keep track of which components have finished
    PRE_TESTComponents = [pre_test_item, pre_test_whitescreen, pre_test_fixation, pre_test_slider, pre_test_mouse, pre_test_timer, pre_test_instr, pre_test_counter, pre_test_mark]
    for thisComponent in PRE_TESTComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    PRE_TESTClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "PRE_TEST"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = PRE_TESTClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=PRE_TESTClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *pre_test_item* updates
        if pre_test_item.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
            # keep track of start time/frame for later
            pre_test_item.frameNStart = frameN  # exact frame index
            pre_test_item.tStart = t  # local t and not account for scr refresh
            pre_test_item.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_item, 'tStartRefresh')  # time at next scr refresh
            pre_test_item.setAutoDraw(True)
        if pre_test_item.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_item.tStop = t  # not accounting for scr refresh
                pre_test_item.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_item, 'tStopRefresh')  # time at next scr refresh
                pre_test_item.setAutoDraw(False)
        
        # *pre_test_whitescreen* updates
        if pre_test_whitescreen.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            pre_test_whitescreen.frameNStart = frameN  # exact frame index
            pre_test_whitescreen.tStart = t  # local t and not account for scr refresh
            pre_test_whitescreen.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_whitescreen, 'tStartRefresh')  # time at next scr refresh
            pre_test_whitescreen.setAutoDraw(True)
        if pre_test_whitescreen.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 0.6-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_whitescreen.tStop = t  # not accounting for scr refresh
                pre_test_whitescreen.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_whitescreen, 'tStopRefresh')  # time at next scr refresh
                pre_test_whitescreen.setAutoDraw(False)
        
        # *pre_test_fixation* updates
        if pre_test_fixation.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_fixation.frameNStart = frameN  # exact frame index
            pre_test_fixation.tStart = t  # local t and not account for scr refresh
            pre_test_fixation.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_fixation, 'tStartRefresh')  # time at next scr refresh
            pre_test_fixation.setAutoDraw(True)
        if pre_test_fixation.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 0.5-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_fixation.tStop = t  # not accounting for scr refresh
                pre_test_fixation.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_fixation, 'tStopRefresh')  # time at next scr refresh
                pre_test_fixation.setAutoDraw(False)
        
        # *pre_test_slider* updates
        if pre_test_slider.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
            # keep track of start time/frame for later
            pre_test_slider.frameNStart = frameN  # exact frame index
            pre_test_slider.tStart = t  # local t and not account for scr refresh
            pre_test_slider.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_slider, 'tStartRefresh')  # time at next scr refresh
            pre_test_slider.setAutoDraw(True)
        if pre_test_slider.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_slider.tStop = t  # not accounting for scr refresh
                pre_test_slider.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_slider, 'tStopRefresh')  # time at next scr refresh
                pre_test_slider.setAutoDraw(False)
        
        # *pre_test_timer* updates
        if pre_test_timer.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_timer.frameNStart = frameN  # exact frame index
            pre_test_timer.tStart = t  # local t and not account for scr refresh
            pre_test_timer.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_timer, 'tStartRefresh')  # time at next scr refresh
            pre_test_timer.setAutoDraw(True)
        if pre_test_timer.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_timer.tStop = t  # not accounting for scr refresh
                pre_test_timer.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_timer, 'tStopRefresh')  # time at next scr refresh
                pre_test_timer.setAutoDraw(False)
        
        # *pre_test_instr* updates
        if pre_test_instr.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_instr.frameNStart = frameN  # exact frame index
            pre_test_instr.tStart = t  # local t and not account for scr refresh
            pre_test_instr.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_instr, 'tStartRefresh')  # time at next scr refresh
            pre_test_instr.setAutoDraw(True)
        if pre_test_instr.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_instr.tStop = t  # not accounting for scr refresh
                pre_test_instr.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_instr, 'tStopRefresh')  # time at next scr refresh
                pre_test_instr.setAutoDraw(False)
        
        # *pre_test_counter* updates
        if pre_test_counter.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            pre_test_counter.frameNStart = frameN  # exact frame index
            pre_test_counter.tStart = t  # local t and not account for scr refresh
            pre_test_counter.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_counter, 'tStartRefresh')  # time at next scr refresh
            pre_test_counter.setAutoDraw(True)
        if pre_test_counter.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_counter.tStop = t  # not accounting for scr refresh
                pre_test_counter.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_counter, 'tStopRefresh')  # time at next scr refresh
                pre_test_counter.setAutoDraw(False)
        
        # *pre_test_mark* updates
        if pre_test_mark.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
            # keep track of start time/frame for later
            pre_test_mark.frameNStart = frameN  # exact frame index
            pre_test_mark.tStart = t  # local t and not account for scr refresh
            pre_test_mark.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(pre_test_mark, 'tStartRefresh')  # time at next scr refresh
            pre_test_mark.setAutoDraw(True)
        if pre_test_mark.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 30.0-frameTolerance:
                # keep track of stop time/frame for later
                pre_test_mark.tStop = t  # not accounting for scr refresh
                pre_test_mark.frameNStop = frameN  # exact frame index
                win.timeOnFlip(pre_test_mark, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in PRE_TESTComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    MaRs_IB_2.addData('pre_test_slider.response', pre_test_slider.getRating())
    MaRs_IB_2.addData('pre_test_slider.rt', pre_test_slider.getRT())
    MaRs_IB_2.addData('pre_test_slider.started', pre_test_slider.tStartRefresh)
    MaRs_IB_2.addData('pre_test_slider.stopped', pre_test_slider.tStopRefresh)
    # store data for MaRs_IB_2 (TrialHandler)
    x, y = pre_test_mouse.getPos()
    buttons = pre_test_mouse.getPressed()
    MaRs_IB_2.addData('pre_test_mouse.x', x)
    MaRs_IB_2.addData('pre_test_mouse.y', y)
    MaRs_IB_2.addData('pre_test_mouse.leftButton', buttons[0])
    MaRs_IB_2.addData('pre_test_mouse.midButton', buttons[1])
    MaRs_IB_2.addData('pre_test_mouse.rightButton', buttons[2])
    thisExp.nextEntry()
    
# completed 10.0 repeats of 'MaRs_IB_2'
...
pass
# keep track of which components have finished
BREAK_1Components = [break_1_instr, break_1_mouse, break_1_btn]
...
while continueRoutine:
    ...
    if break_1_instr.status == NOT_STARTED and t >= 0.0:
        # keep track of start time/frame for later
        break_1_instr.frameNStart = frameN  # exact frame index
        break_1_instr.tStart = t  # local t and not account for scr refresh
        break_1_instr.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(break_1_instr, 'tStartRefresh')  # time at next scr refresh
        break_1_instr.setAutoDraw(True)
    if break_1_instr.status == STARTED:
        if bool(breakEnded):
            # keep track of stop time/frame for later
            break_1_instr.tStop = t  # not accounting for scr refresh
            break_1_instr.frameNStop = frameN  # exact frame index
            win.timeOnFlip(break_1_instr, 'tStopRefresh')  # time at next scr refresh
            break_1_instr.setAutoDraw(False)
    
    # *break_1_btn* updates
    if break_1_btn.status == NOT_STARTED and t>=0.0:
        # keep track of start time/frame for later
        break_1_btn.frameNStart = frameN  # exact frame index
        break_1_btn.tStart = t  # local t and not account for scr refresh
        break_1_btn.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(break_1_btn, 'tStartRefresh')  # time at next scr refresh
        break_1_btn.setAutoDraw(True)
    if break_1_btn.status == STARTED:
        if bool(breakEnded):
            # keep track of stop time/frame for later
            break_1_btn.tStop = t  # not accounting for scr refresh
            break_1_btn.frameNStop = frameN  # exact frame index
            win.timeOnFlip(break_1_btn, 'tStopRefresh')  # time at next scr refresh
...
for thisComponent in BREAK_1Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('break_1_instr.started', break_1_instr.tStartRefresh)
thisExp.addData('break_1_instr.stopped', break_1_instr.tStopRefresh)
# store data for thisExp (ExperimentHandler)
x, y = break_1_mouse.getPos()
buttons = break_1_mouse.getPressed()
thisExp.addData('break_1_mouse.x', x)
thisExp.addData('break_1_mouse.y', y)
thisExp.addData('break_1_mouse.leftButton', buttons[0])
thisExp.addData('break_1_mouse.midButton', buttons[1])
thisExp.addData('break_1_mouse.rightButton', buttons[2])
thisExp.nextEntry()
pass
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
INTROComponents = [intro_text, alice, bob, blue_star_door, purple_diamond_door, intro_btn, intro_mouse]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if blue_star_door.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        blue_star_door.frameNStart = frameN  # exact frame index
        blue_star_door.tStart = t  # local t and not account for scr refresh
        blue_star_door.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(blue_star_door, 'tStartRefresh')  # time at next scr refresh
        blue_star_door.setAutoDraw(True)
    if blue_star_door.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > blue_star_door.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            blue_star_door.tStop = t  # not accounting for scr refresh
            blue_star_door.frameNStop = frameN  # exact frame index
            win.timeOnFlip(blue_star_door, 'tStopRefresh')  # time at next scr refresh
            blue_star_door.setAutoDraw(False)
    
    # *purple_diamond_door* updates
    if purple_diamond_door.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        purple_diamond_door.frameNStart = frameN  # exact frame index
        purple_diamond_door.tStart = t  # local t and not account for scr refresh
        purple_diamond_door.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(purple_diamond_door, 'tStartRefresh')  # time at next scr refresh
        purple_diamond_door.setAutoDraw(True)
    if purple_diamond_door.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > purple_diamond_door.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            purple_diamond_door.tStop = t  # not accounting for scr refresh
            purple_diamond_door.frameNStop = frameN  # exact frame index
            win.timeOnFlip(purple_diamond_door, 'tStopRefresh')  # time at next scr refresh
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
HINTComponents = [intro_text_8, arrow, alice_5, bob_5, blue_star_door_2, purple_diamond_door_2, hint_btn, hint_mouse]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if blue_star_door_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        blue_star_door_2.frameNStart = frameN  # exact frame index
        blue_star_door_2.tStart = t  # local t and not account for scr refresh
        blue_star_door_2.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(blue_star_door_2, 'tStartRefresh')  # time at next scr refresh
        blue_star_door_2.setAutoDraw(True)
    if blue_star_door_2.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > blue_star_door_2.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            blue_star_door_2.tStop = t  # not accounting for scr refresh
            blue_star_door_2.frameNStop = frameN  # exact frame index
            win.timeOnFlip(blue_star_door_2, 'tStopRefresh')  # time at next scr refresh
            blue_star_door_2.setAutoDraw(False)
    
    # *purple_diamond_door_2* updates
    if purple_diamond_door_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        purple_diamond_door_2.frameNStart = frameN  # exact frame index
        purple_diamond_door_2.tStart = t  # local t and not account for scr refresh
        purple_diamond_door_2.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(purple_diamond_door_2, 'tStartRefresh')  # time at next scr refresh
        purple_diamond_door_2.setAutoDraw(True)
    if purple_diamond_door_2.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > purple_diamond_door_2.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            purple_diamond_door_2.tStop = t  # not accounting for scr refresh
            purple_diamond_door_2.frameNStop = frameN  # exact frame index
            win.timeOnFlip(purple_diamond_door_2, 'tStopRefresh')  # time at next scr refresh
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
MERGE_INTROComponents = [intro_text_2, alice_2, merge_example, blue_star_door_3, merge_intro_btn, merge_intro_mouse]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if blue_star_door_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        blue_star_door_3.frameNStart = frameN  # exact frame index
        blue_star_door_3.tStart = t  # local t and not account for scr refresh
        blue_star_door_3.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(blue_star_door_3, 'tStartRefresh')  # time at next scr refresh
        blue_star_door_3.setAutoDraw(True)
    if blue_star_door_3.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > blue_star_door_3.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            blue_star_door_3.tStop = t  # not accounting for scr refresh
            blue_star_door_3.frameNStop = frameN  # exact frame index
            win.timeOnFlip(blue_star_door_3, 'tStopRefresh')  # time at next scr refresh
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
MERGE_TEST_INTROComponents = [intro_text_6, alice_4, merge_example_2, blue_star_door_4, merge_test_intro_btn, merge_test_intro_mouse]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if blue_star_door_4.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        blue_star_door_4.frameNStart = frameN  # exact frame index
        blue_star_door_4.tStart = t  # local t and not account for scr refresh
        blue_star_door_4.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(blue_star_door_4, 'tStartRefresh')  # time at next scr refresh
        blue_star_door_4.setAutoDraw(True)
    if blue_star_door_4.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > blue_star_door_4.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            blue_star_door_4.tStop = t  # not accounting for scr refresh
            blue_star_door_4.frameNStop = frameN  # exact frame index
            win.timeOnFlip(blue_star_door_4, 'tStopRefresh')  # time at next scr refresh
...
for thisTEST_1 in TEST_1:
    ...
    # keep track of which components have finished
    MERGE_TESTComponents = [merge_test_scale_instr, merge_test_ans_instr, merge_test_instr, merge_test_scale_right, merge_test_scale_left, merge_test_sep, merge_test, merge_test_scale, merge_test_btn, merge_test_compare, merge_test_mouse, merge_test_timer]
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
SORT_INTROComponents = [intro_text_3, bob_2, sort_example, purple_diamond_door_3, sort_intro_btn, sort_intro_mouse]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if purple_diamond_door_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        purple_diamond_door_3.frameNStart = frameN  # exact frame index
        purple_diamond_door_3.tStart = t  # local t and not account for scr refresh
        purple_diamond_door_3.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(purple_diamond_door_3, 'tStartRefresh')  # time at next scr refresh
        purple_diamond_door_3.setAutoDraw(True)
    if purple_diamond_door_3.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > purple_diamond_door_3.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            purple_diamond_door_3.tStop = t  # not accounting for scr refresh
            purple_diamond_door_3.frameNStop = frameN  # exact frame index
            win.timeOnFlip(purple_diamond_door_3, 'tStopRefresh')  # time at next scr refresh
...
for thisTRAIN_2 in TRAIN_2:
    ...
    right = x+w/2
    # keep track of which components have finished
    SORT_TRAINComponents = [sort_train_scale_instr, sort_train_ans_instr, sort_train_instr, sort_train_scale_right, sort_train_scale_left, sort_train_sep, sort_train_board, sort_train_scale, sort_train_ex_1, sort_train_ex_2, sort_train_ex_3, sort_train_ex_4, sort_train_ex_5, sort_train_ex_6, sort_train_ex_7, sort_train_ex_8, sort_train_ex_9, sort_train_ex_10, sort_train_ex_11, sort_train_ex_12, sort_train_btn, sort_train_compare, sort_train_mouse, sort_train_timer, sort_train_hint]
    ...
    right = x+w/2
    # keep track of which components have finished
    SORT_EXPLComponents = [sort_expl_scale_instr, sort_expl_feedback_1, sort_expl_feedback_2, sort_expl_instr, sort_expl_scale_right, sort_expl_scale_left, sort_expl_sep, sort_expl_board, sort_expl_scale, sort_expl_ex_1, sort_expl_ex_2, sort_expl_ex_3, sort_expl_ex_4, sort_expl_ex_5, sort_expl_ex_6, sort_expl_ex_7, sort_expl_ex_8, sort_expl_ex_9, sort_expl_ex_10, sort_expl_ex_11, sort_expl_ex_12, sort_expl_btn, sort_expl_compare, sort_expl_mouse, sort_expl_timer, sort_expl_hint]
...
pass
# keep track of which components have finished
BREAK_2Components = [break_2_instr, break_2_mouse, break_2_btn]
...
while continueRoutine:
    ...
    if break_2_instr.status == NOT_STARTED and t >= 0.0:
        # keep track of start time/frame for later
        break_2_instr.frameNStart = frameN  # exact frame index
        break_2_instr.tStart = t  # local t and not account for scr refresh
        break_2_instr.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(break_2_instr, 'tStartRefresh')  # time at next scr refresh
        break_2_instr.setAutoDraw(True)
    if break_2_instr.status == STARTED:
        if bool(breakEnded):
            # keep track of stop time/frame for later
            break_2_instr.tStop = t  # not accounting for scr refresh
            break_2_instr.frameNStop = frameN  # exact frame index
            win.timeOnFlip(break_2_instr, 'tStopRefresh')  # time at next scr refresh
            break_2_instr.setAutoDraw(False)
    
    # *break_2_btn* updates
    if break_2_btn.status == NOT_STARTED and t>=0.0:
        # keep track of start time/frame for later
        break_2_btn.frameNStart = frameN  # exact frame index
        break_2_btn.tStart = t  # local t and not account for scr refresh
        break_2_btn.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(break_2_btn, 'tStartRefresh')  # time at next scr refresh
        break_2_btn.setAutoDraw(True)
    if break_2_btn.status == STARTED:
        if bool(breakEnded):
            # keep track of stop time/frame for later
            break_2_btn.tStop = t  # not accounting for scr refresh
            break_2_btn.frameNStop = frameN  # exact frame index
            win.timeOnFlip(break_2_btn, 'tStopRefresh')  # time at next scr refresh
...
for thisComponent in BREAK_2Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('break_2_instr.started', break_2_instr.tStartRefresh)
thisExp.addData('break_2_instr.stopped', break_2_instr.tStopRefresh)
# store data for thisExp (ExperimentHandler)
x, y = break_2_mouse.getPos()
buttons = break_2_mouse.getPressed()
thisExp.addData('break_2_mouse.x', x)
thisExp.addData('break_2_mouse.y', y)
thisExp.addData('break_2_mouse.leftButton', buttons[0])
thisExp.addData('break_2_mouse.midButton', buttons[1])
thisExp.addData('break_2_mouse.rightButton', buttons[2])
thisExp.nextEntry()
pass
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
SORT_TEST_INTROComponents = [intro_text_7, bob_4, sort_example_2, purple_diamond_door_4, sort_test_intro_btn, sort_test_intro_mouse]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if purple_diamond_door_4.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        purple_diamond_door_4.frameNStart = frameN  # exact frame index
        purple_diamond_door_4.tStart = t  # local t and not account for scr refresh
        purple_diamond_door_4.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(purple_diamond_door_4, 'tStartRefresh')  # time at next scr refresh
        purple_diamond_door_4.setAutoDraw(True)
    if purple_diamond_door_4.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > purple_diamond_door_4.tStartRefresh + 120.0-frameTolerance:
            # keep track of stop time/frame for later
            purple_diamond_door_4.tStop = t  # not accounting for scr refresh
            purple_diamond_door_4.frameNStop = frameN  # exact frame index
            win.timeOnFlip(purple_diamond_door_4, 'tStopRefresh')  # time at next scr refresh
...
for thisTEST_2 in TEST_2:
    ...
    right = x+w/2
    # keep track of which components have finished
    SORT_TESTComponents = [sort_test_scale_instr, sort_test_ans_instr, sort_test_instr, sort_test_scale_right, sort_test_scale_left, sort_test_sep, sort_test_board, sort_test_scale, sort_test_ex_1, sort_test_ex_2, sort_test_ex_3, sort_test_ex_4, sort_test_ex_5, sort_test_ex_6, sort_test_ex_7, sort_test_ex_8, sort_test_ex_9, sort_test_ex_10, sort_test_ex_11, sort_test_ex_12, sort_test_btn, sort_test_compare, sort_test_mouse, sort_test_timer]
...
for thisREVIEW in REVIEW:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if review_question.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > review_question.tStartRefresh + 180.0-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if review_img_1.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > review_img_1.tStartRefresh + 180.0-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if review_img_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > review_img_2.tStartRefresh + 180.0-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if review_timer.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > review_timer.tStartRefresh + 180.0-frameTolerance:
                # keep track of stop time/frame for later
