...
STRUCTURE_TRAINClock = core.Clock()
# Set experiment start values for variable component structure_train_merge_records
structure_train_merge_records = ''
structure_train_merge_recordsContainer = []
# Set experiment start values for variable component structure_train_merge_limit
structure_train_merge_limit = ''
structure_train_merge_limitContainer = []
# Set experiment start values for variable component structure_train_mergeN
structure_train_mergeN = ''
structure_train_mergeNContainer = []
# Set experiment start values for variable component structure_train_labels
structure_train_labels = ''
structure_train_labelsContainer = []
# Set experiment start values for variable component structure_train_path_base
structure_train_path_base = ''
structure_train_path_baseContainer = []
# Set experiment start values for variable component structure_train_input
structure_train_input = ''
structure_train_inputContainer = []
structure_train_merge_instr = visual.TextStim(win=win, name='structure_train_merge_instr',
    text='',
    font='Open Sans',
    pos=(-0.55,0.4), height=1.0, wrapWidth=0.3, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-6.0);
structure_train_feedback = visual.TextStim(win=win, name='structure_train_feedback',
    text=None,
    font='Open Sans',
    pos=(-0.75, 0.6), height=0.03, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-7.0);
structure_train_instr = visual.TextStim(win=win, name='structure_train_instr',
    text='1. Some instr\n\n2. Some instr\n\n3. Some instr\n\n4. Some instr',
    font='Open Sans',
    ...
    languageStyle='LTR',
    depth=-8.0);
structure_train_hint = visual.TextStim(win=win, name='structure_train_hint',
    text=None,
    font='Open Sans',
    ...
    languageStyle='LTR',
    depth=-9.0);
structure_train_sublist_right = visual.TextBox2(
     win, text=None, font='Open Sans',
     pos=(-0.45, 0.3),     letterHeight=0.03,
...
structure_train_sublist_left = visual.TextBox2(
     win, text=None, font='Open Sans',
     pos=(-0.65,0.3),     letterHeight=0.03,
     size=(0.15,0.07), borderWidth=2.0,
     color='black', colorSpace='rgb',
     opacity=None,
     bold=False, italic=False,
...
structure_train_sep = visual.ImageStim(
    win=win,
    name='structure_train_sep', 
    image='materials/merge_sort/imgs/white_BG.png', mask=None,
    ori=0.0, pos=(0, -0.2), size=(1.5,0.005),
    color=[1,1,1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-12.0)
structure_train_board = visual.ImageStim(
    win=win,
    name='structure_train_board', 
    image='sin', mask=None,
    ori=0.0, pos=(0.3, 0.15), size=(1, 0.6),
    color=[1,1,1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-13.0)
structure_train_btn = visual.ImageStim(
    win=win,
    name='structure_train_btn', 
    image='materials/imgs/submit.png', mask=None,
    ori=0.0, pos=(0.5, -0.35), size=[0.24,0.1],
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-14.0)
structure_train_merge = visual.ImageStim(
    win=win,
    name='structure_train_merge', 
    image='materials/merge_sort/imgs/blue_star.png', mask=None,
    ori=0.0, pos=(-0.55, 0.15), size=(0.3, 0.09),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-15.0)
structure_train_mouse = event.Mouse(win=win)
x, y = [None, None]
structure_train_mouse.mouseClock = core.Clock()
structure_train_timer = visual.TextStim(win=win, name='structure_train_timer',
    text=None,
    font='Open Sans',
    pos=(0.65, -0.05), height=0.03, wrapWidth=None, ori=0.0, 
    color='orange', colorSpace='rgb', opacity=None, 
...
TRAIN_1 = data.TrialHandler(nReps=0.0, method='sequential',
...
# completed 0.0 repeats of 'TRAIN_1'
...
# set up handler to look after randomisation of conditions etc
TEST_1 = data.TrialHandler(nReps=0.0, method='sequential',
                           extraInfo=expInfo, originPath=-1,
...
# completed 0.0 repeats of 'TEST_1'
...
TRAIN_2 = data.TrialHandler(nReps=1.0, method='sequential',
                            extraInfo=expInfo, originPath=-1,
                            trialList=data.importConditions('interface/materials/structure_train_cond.csv'),
...
for thisTRAIN_2 in TRAIN_2:
    ...
    # update component parameters for each repeat
    structure_train_merge_records = []  # Set routine start values for structure_train_merge_records
    structure_train_merge_limit = ms_compare  # Set routine start values for structure_train_merge_limit
    structure_train_mergeN = 0  # Set routine start values for structure_train_mergeN
    structure_train_labels = encryption  # Set routine start values for structure_train_labels
    thisExp.addData('structure_train_labels.routineStartVal', structure_train_labels)  # Save exp start value
    structure_train_path_base = img_path_base  # Set routine start values for structure_train_path_base
    structure_train_input = input  # Set routine start values for structure_train_input
    thisExp.addData('structure_train_input.routineStartVal', structure_train_input)  # Save exp start value
    structure_train_merge_instr.setColor('white', colorSpace='rgb')
    structure_train_merge_instr.setText('Apply the BLUE STAR by typing leftmost fruit labels of two chosen boxes in both LHS and RHS textboxes')
    structure_train_merge_instr.setHeight(0.025)
    structure_train_hint.setText('')
    structure_train_sublist_right.reset()
    structure_train_sublist_right.setText('')
    structure_train_sublist_left.reset()
    ...
    pass
    # keep track of which components have finished
    STRUCTURE_TRAINComponents = [structure_train_merge_instr, structure_train_feedback, structure_train_instr, structure_train_hint, structure_train_sublist_right, structure_train_sublist_left, structure_train_sep, structure_train_board, structure_train_btn, structure_train_merge, structure_train_mouse, structure_train_timer]
    for thisComponent in STRUCTURE_TRAINComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    STRUCTURE_TRAINClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "STRUCTURE_TRAIN"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = STRUCTURE_TRAINClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=STRUCTURE_TRAINClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *structure_train_merge_instr* updates
        if structure_train_merge_instr.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_merge_instr.frameNStart = frameN  # exact frame index
            structure_train_merge_instr.tStart = t  # local t and not account for scr refresh
            structure_train_merge_instr.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_merge_instr, 'tStartRefresh')  # time at next scr refresh
            structure_train_merge_instr.setAutoDraw(True)
        if structure_train_merge_instr.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > structure_train_merge_instr.tStartRefresh + 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_merge_instr.tStop = t  # not accounting for scr refresh
                structure_train_merge_instr.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_merge_instr, 'tStopRefresh')  # time at next scr refresh
                structure_train_merge_instr.setAutoDraw(False)
        
        # *structure_train_feedback* updates
        if structure_train_feedback.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_feedback.frameNStart = frameN  # exact frame index
            structure_train_feedback.tStart = t  # local t and not account for scr refresh
            structure_train_feedback.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_feedback, 'tStartRefresh')  # time at next scr refresh
            structure_train_feedback.setAutoDraw(True)
        if structure_train_feedback.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > structure_train_feedback.tStartRefresh + 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_feedback.tStop = t  # not accounting for scr refresh
                structure_train_feedback.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_feedback, 'tStopRefresh')  # time at next scr refresh
                structure_train_feedback.setAutoDraw(False)
        
        # *structure_train_instr* updates
        if structure_train_instr.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_instr.frameNStart = frameN  # exact frame index
            structure_train_instr.tStart = t  # local t and not account for scr refresh
            structure_train_instr.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_instr, 'tStartRefresh')  # time at next scr refresh
            structure_train_instr.setAutoDraw(True)
        if structure_train_instr.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > structure_train_instr.tStartRefresh + 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_instr.tStop = t  # not accounting for scr refresh
                structure_train_instr.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_instr, 'tStopRefresh')  # time at next scr refresh
                structure_train_instr.setAutoDraw(False)
        
        # *structure_train_hint* updates
        if structure_train_hint.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_hint.frameNStart = frameN  # exact frame index
            structure_train_hint.tStart = t  # local t and not account for scr refresh
            structure_train_hint.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_hint, 'tStartRefresh')  # time at next scr refresh
            structure_train_hint.setAutoDraw(True)
        if structure_train_hint.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_hint.tStop = t  # not accounting for scr refresh
                structure_train_hint.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_hint, 'tStopRefresh')  # time at next scr refresh
                structure_train_hint.setAutoDraw(False)
        
        # *structure_train_sublist_right* updates
        if structure_train_sublist_right.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_sublist_right.frameNStart = frameN  # exact frame index
            structure_train_sublist_right.tStart = t  # local t and not account for scr refresh
            structure_train_sublist_right.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_sublist_right, 'tStartRefresh')  # time at next scr refresh
            structure_train_sublist_right.setAutoDraw(True)
        if structure_train_sublist_right.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > structure_train_sublist_right.tStartRefresh + 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_sublist_right.tStop = t  # not accounting for scr refresh
                structure_train_sublist_right.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_sublist_right, 'tStopRefresh')  # time at next scr refresh
                structure_train_sublist_right.setAutoDraw(False)
        
        # *structure_train_sublist_left* updates
        if structure_train_sublist_left.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_sublist_left.frameNStart = frameN  # exact frame index
            structure_train_sublist_left.tStart = t  # local t and not account for scr refresh
            structure_train_sublist_left.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_sublist_left, 'tStartRefresh')  # time at next scr refresh
            structure_train_sublist_left.setAutoDraw(True)
        if structure_train_sublist_left.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > structure_train_sublist_left.tStartRefresh + 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_sublist_left.tStop = t  # not accounting for scr refresh
                structure_train_sublist_left.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_sublist_left, 'tStopRefresh')  # time at next scr refresh
                structure_train_sublist_left.setAutoDraw(False)
        
        # *structure_train_sep* updates
        if structure_train_sep.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_sep.frameNStart = frameN  # exact frame index
            structure_train_sep.tStart = t  # local t and not account for scr refresh
            structure_train_sep.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_sep, 'tStartRefresh')  # time at next scr refresh
            structure_train_sep.setAutoDraw(True)
        if structure_train_sep.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > structure_train_sep.tStartRefresh + 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_sep.tStop = t  # not accounting for scr refresh
                structure_train_sep.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_sep, 'tStopRefresh')  # time at next scr refresh
                structure_train_sep.setAutoDraw(False)
        
        # *structure_train_board* updates
        if structure_train_board.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_board.frameNStart = frameN  # exact frame index
            structure_train_board.tStart = t  # local t and not account for scr refresh
            structure_train_board.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_board, 'tStartRefresh')  # time at next scr refresh
            structure_train_board.setAutoDraw(True)
        if structure_train_board.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > structure_train_board.tStartRefresh + 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_board.tStop = t  # not accounting for scr refresh
                structure_train_board.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_board, 'tStopRefresh')  # time at next scr refresh
                structure_train_board.setAutoDraw(False)
        
        # *structure_train_btn* updates
        if structure_train_btn.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            structure_train_btn.frameNStart = frameN  # exact frame index
            structure_train_btn.tStart = t  # local t and not account for scr refresh
            structure_train_btn.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_btn, 'tStartRefresh')  # time at next scr refresh
            structure_train_btn.setAutoDraw(True)
        if structure_train_btn.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_btn.tStop = t  # not accounting for scr refresh
                structure_train_btn.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_btn, 'tStopRefresh')  # time at next scr refresh
                structure_train_btn.setAutoDraw(False)
        
        # *structure_train_merge* updates
        if structure_train_merge.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            structure_train_merge.frameNStart = frameN  # exact frame index
            structure_train_merge.tStart = t  # local t and not account for scr refresh
            structure_train_merge.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_merge, 'tStartRefresh')  # time at next scr refresh
            structure_train_merge.setAutoDraw(True)
        if structure_train_merge.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_merge.tStop = t  # not accounting for scr refresh
                structure_train_merge.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_merge, 'tStopRefresh')  # time at next scr refresh
                structure_train_merge.setAutoDraw(False)
        
        # *structure_train_timer* updates
        if structure_train_timer.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            structure_train_timer.frameNStart = frameN  # exact frame index
            structure_train_timer.tStart = t  # local t and not account for scr refresh
            structure_train_timer.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(structure_train_timer, 'tStartRefresh')  # time at next scr refresh
            structure_train_timer.setAutoDraw(True)
        if structure_train_timer.status == STARTED:
            # is it time to stop? (based on local clock)
            if tThisFlip > 240.0-frameTolerance:
                # keep track of stop time/frame for later
                structure_train_timer.tStop = t  # not accounting for scr refresh
                structure_train_timer.frameNStop = frameN  # exact frame index
                win.timeOnFlip(structure_train_timer, 'tStopRefresh')  # time at next scr refresh
                structure_train_timer.setAutoDraw(False)
        # python code to be filled if having offlane exp
        pass
    ...
    for thisComponent in STRUCTURE_TRAINComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('structure_train_merge_records.routineEndVal', structure_train_merge_records)  # Save end routine value
    thisExp.addData('structure_train_mergeN.routineEndVal', structure_train_mergeN)  # Save end routine value
    TRAIN_2.addData('structure_train_sublist_right.text',structure_train_sublist_right.text)
    TRAIN_2.addData('structure_train_sublist_left.text',structure_train_sublist_left.text)
    # store data for TRAIN_2 (TrialHandler)
    x, y = structure_train_mouse.getPos()
    buttons = structure_train_mouse.getPressed()
    TRAIN_2.addData('structure_train_mouse.x', x)
    TRAIN_2.addData('structure_train_mouse.y', y)
    TRAIN_2.addData('structure_train_mouse.leftButton', buttons[0])
    TRAIN_2.addData('structure_train_mouse.midButton', buttons[1])
    TRAIN_2.addData('structure_train_mouse.rightButton', buttons[2])
    thisExp.nextEntry()
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
EXP_CHECKComponents = [exp_check_question, exp_check_res, exp_check_btn, exp_check_mouse]
