...
g1 = extract_from_CSV([DATA_DIR_AMT_GROUP1], trace_analysis_method='chi_sq_2x2', trace_similarity_analysis=False,
                      similarity_graphs=True,
                      save_graphs=True,
                      show_records=False,
                      chi_sq_significance=0.005, filter_std_multiplier=1, save_path="../results/amt/", verbose=False,
                      pre_test_mean_acc=0.6513439999999999, pre_test_std_acc=0.17209328186771264,
                      # exclude_algorithms=['BS', 'IS', 'QS'],
                      # is_visual_trace_enabled=True,
                      filter_name="")
g2 = extract_from_CSV([DATA_DIR_AMT_GROUP2], trace_analysis_method='chi_sq_2x2', trace_similarity_analysis=False,
                      similarity_graphs=True,
                      save_graphs=True,
                      show_records=False,
                      chi_sq_significance=0.005, filter_std_multiplier=1, save_path="../results/amt/", verbose=False,
                      ...
                      # exclude_algorithms=['BS', 'IS', 'QS'],
                      filter_name="")
g3 = extract_from_CSV([DATA_DIR_AMT_GROUP3], trace_analysis_method='chi_sq_2x2', trace_similarity_analysis=False,
                      similarity_graphs=True,
                      save_graphs=True,
                      show_records=False,
                      chi_sq_significance=0.005, filter_std_multiplier=1, save_path="../results/amt/", verbose=False,
                      ...
                      # exclude_algorithms=['BS', 'IS', 'QS'],
                      filter_name="")
g4 = extract_from_CSV([DATA_DIR_AMT_GROUP4], trace_analysis_method='chi_sq_2x2', trace_similarity_analysis=False,
                      similarity_graphs=True,
                      save_graphs=True,
                      show_records=False,
                      chi_sq_significance=0.005, filter_std_multiplier=1, save_path="../results/amt/", verbose=False,
...
sort_statistical_tests([g1, g2, g3, g4], ["G1", "G2", "G3", "G4"], anova_two_way=True, tukey_two_way=True,#
                       ...
                       record_alias=["Test Response Score", "Test No. Comparisons", "Test Response Time"]
                       )
