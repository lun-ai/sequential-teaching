...
let expInfo = {'Session ID': ''};

// Start code blocks for 'Before Experiment'
const sid = sessionStorage.getItem("currentSessionId");
if (sid !== undefined && sid !== null) {
    expInfo['Session ID'] = sid;
} else {
    // assuming < 300 participant would take exper => assign safe sid
    // solution should be improved for better coverage
    expInfo['Session ID'] = "300";
}
