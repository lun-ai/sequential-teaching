...
import { MonotonicClock } from './util-2021.1.4.js';
import { offerDataForDownload, selectFromArray, turnSquareBracketsIntoArrays, shuffle } from './util-2021.1.4.js';
		...
		try
		{
			...
			if (['csv', 'odp', 'xls', 'xlsx'].indexOf(resourceExtension) > -1)
			{
				...
				for (let r = 0; r < selectedRows.length; ++r)
				{
					...
					{
						let value = row[l];
						const arrayMaybe = turnSquareBracketsIntoArrays(value);
