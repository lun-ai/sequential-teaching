import { MonotonicClock, Clock } from './util-2021.1.4.js';
import { Scheduler } from './util-2021.1.4.js';
import { PsychObject } from './util-2021.1.4.js';
import { getRequestError, toString, getUrlParameters, detectBrowser, to_win } from './util-2021.1.4.js';
import { ExperimentHandler } from './data-2021.1.4.js';
import { PsychObject as PsychObject$1, Color, MonotonicClock as MonotonicClock$1 } from './util-2021.1.4.js';
 ...
 * @license Distributed under the terms of the MIT License
 */
class Window extends PsychObject$1
{
	...
	_writeLogOnFlip()
	{
		const logTime = MonotonicClock$1.getReferenceTime();
