import { Color } from './util-2021.1.4.js';
import { ColorMixin } from './util-2021.1.4.js';
import { mix, toNumerical, getPositionFromObject, toString, to_unit, to_pixiPoint, to_px, shuffle, IsPointInsidePolygon } from './util-2021.1.4.js';
import { TrialHandler } from './data-2021.1.4.js';
import { MinimalStim } from './core-2021.1.4.js';
import { WindowMixin } from './core-2021.1.4.js';
import { Clock } from './util-2021.1.4.js';
import { PsychoJS } from './core-2021.1.4.js';
...
class Slider extends mix(VisualStim).with(ColorMixin, WindowMixin)
{
	...
	_estimateBoundingBox()
	{
		...
		const pos_px = to_px(this._pos, this._units, this._win);
